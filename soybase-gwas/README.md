These files are created by merging a couple tables in the SoyBase database to provide a single file per GWAS experiment, with records giving QTLs and markers as follows:
```
TaxonID	3847
Variety	Williams82
experiment_id	1
